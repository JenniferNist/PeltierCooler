...
#else
  uint8_t blueTermometer[] = { 0x28, 0x8C, 0xA5, 0xC5, 0x02, 0x00, 0x00, 0x9F };
  uint8_t brownTermometer[] = { 0x28, 0x87, 0x85, 0xC5, 0x02, 0x00, 0x00, 0x9F };
#endif
